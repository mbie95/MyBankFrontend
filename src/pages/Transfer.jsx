...
const Transfer = () => {
    ...
    const verifyDestinationAccount = async () => {
        ...
        try {
            ...
            setError('Error verifying destination account ', error.response?.data?.message);
        } finally {
            ...
            <div className="transaction-content">
                <div className="transaction-form-section">
                    ...
                    <form onSubmit={handleSubmit} className="transaction-form">
                        ...
                        <div className="form-group">
                            ...
                            <div className="form-group-dest-acc">
                                <input
                                    type="text"
                                ...
                                <button
                                    type="button"
                                    className="verify-btn btn-secondary"
                ...
                <div className="transaction-guidelines">
                    ...
                    <ul>
                        ...
                        <li>Transfer cannot be reversed once processed</li>
