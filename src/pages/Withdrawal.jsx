...
const Withdrawal = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await apiService.makeWithdrawal(withdrawalData);
            ...
            <div className="transaction-content">
                <div className="transaction-form-section">
                    ...
                    <form onSubmit={handleSubmit} className="transaction-form">
                        ...
                        <button
                            ...
                            disabled={loading}
                        >
                            {loading ? 'Processing Withdrawal...' : 'Withdrawal Money'}
                        </button>
                    </form>
                </div>
                <div className="transaction-guidelines">
                    ...
                    <ul>
                        ...
                        <li>Withdrawal cannot be reversed once processed</li>
